...
# Manipulate channels
choice = int(input('Choice the colour format of image(1 or 2)\n1.Greyscale\n2.Coloured\n\n'))
img_input = input('Enter the path of the image with extension\n')
quality = int(input('Enter the quality of image(Warning:Higher quality will take higher time to execute\nFor test purpose choice 1)\n1.256 by 256\n2.512 by 512\n3.1024 by 1024\n'))
